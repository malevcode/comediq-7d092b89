...
const Hero = () => {
  ...
  return <section className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 flex items-start justify-center px-4">
      <div className="max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
          ...
          <div className="flex justify-center order-1 lg:order-2 -mt-4">
            <img src="/lovable-uploads/fc65b384-6c71-4c5e-9c70-52716864f5ad.png" alt="Comediq Mascot" className="w-48 sm:w-64 lg:w-80 h-auto max-w-full object-cover" />
          </div>
        </div>
      </div>
    </section>;

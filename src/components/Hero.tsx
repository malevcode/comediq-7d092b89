      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-8 mx-[86px]">
              Find open mics, track your sets, analyze your performance, and grow your comedy career - all in one place.
            </p>
            <Button onClick={onJoinWaitlist} className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 text-lg rounded-full transition-all duration-300 transform hover:scale-105 mb-8">
              Join the Waitlist
            </Button>
            <p className="text-gray-600 max-w-2xl mx-[159px] my-0 py-0 px-0 text-base">

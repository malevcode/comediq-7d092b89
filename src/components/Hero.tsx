      ...
      <div className="max-w-6xl w-full mx-auto">
        ...
        <div className="grid grid-cols-[1fr_auto] lg:grid-cols-2 gap-4 lg:gap-8 items-center">
          <div className="text-left">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-2 lg:mb-4">
              Comediq
            </h1>
            <p className="text-sm sm:text-lg lg:text-2xl text-gray-700 mb-4 lg:mb-6 leading-relaxed">

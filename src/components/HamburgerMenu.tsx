...
import { Home, MicVocal, Eye, User, Book, Search, Calendar, TrendingUp, Menu, ChevronRight, Briefcase, Ticket, Star, Bookmark, ListMusic, TicketCheck, Sparkles } from "lucide-react";

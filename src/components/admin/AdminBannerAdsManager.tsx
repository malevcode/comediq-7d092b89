...
export function AdminBannerAdsManager() {
  ...
  const startEdit = (ad: BannerAd) => {
    setEditingId(ad.id);
    setEditData({ ...ad, amount_paid: ad.amount_paid ?? '' });
  };
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-bold">Banner Ads</h2>
                ...
                {isEditing ? (
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <Badge variant={ad.position === 'top' ? 'default' : 'secondary'} className="text-[10px]">
                            {ad.position}
                          </Badge>
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <Button size="sm" variant="outline" onClick={() => startEdit(ad)} className="h-7 text-xs">
                        Edit
                      </Button>
                      <AlertDialog>

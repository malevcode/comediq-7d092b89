                ...
                {OPEN_MIC_FIELDS.map((field: string) => (
                  <div key={field} className="flex flex-col">
                    ...
                    {field === 'Start Time' ? (
                      ...
                      <input
                        className={`border rounded px-2 py-1 text-sm${errors[field] ? ' border-red-500' : ''}`}
                  ...
                  <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction asChild>
                        <Button className="bg-green-600 hover:bg-green-700 text-white flex items-center gap-1" onClick={() => handleApprove(req.unique_identifier)} disabled={submitting}>

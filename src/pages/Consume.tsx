          ...
          <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 pb-20">
            <div className="max-w-6xl mx-auto px-4 py-8">
              ...
              <div className="grid gap-6">
                {comedySpecials.map(special => <Card key={special.id} className="overflow-hidden">
                    <CardContent className="p-4 sm:p-6">
                      <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                        <div className="flex-shrink-0 mx-auto sm:mx-0">
                          <img src={special.poster} alt={special.title} className="w-24 h-36 sm:w-32 sm:h-48 object-cover rounded-lg" />
                        </div>
            ...
            <div className="max-w-6xl mx-auto px-4 py-8">
              <div className="text-center">
                ...
                <div className="flex justify-center">
                  <img src="/lovable-uploads/05168ab8-2327-4ef4-90ca-54c3f66da85c.png" alt="Discover Shows Character" className="w-64 h-auto" />
                </div>
              </div>
            </div>
          </div>
